...
namespace ProyectoGPS.AccesoDatos
{
    public class AccesoDatosPostgreSql : IAccesoDatos
    {
        ...
        {
            this.LimpiarEstado();
            ConexionPG = new NpgsqlConnection("Server=" + servidor + ";Port=" + puerto + ";Database=" + baseDatos + ";User Id=" + usuario + ";Password=" + contrasena);
        ...
        public DataSet EjecutarConsultaSQL(String sql)
        {
            ...
            try
            {
                var oDataAdapter = new NpgsqlDataAdapter(sql, ConexionPG);
        ...
        public DataSet EjecutarConsultaSQL(String sql, IEnumerable parametros)
        {
            ...
            {
                var oDataAdapter = new NpgsqlDataAdapter(sql, ConexionPG);
                var cmd = new NpgsqlCommand(sql, ConexionPG);
        ...
        {
            int resultado = 0;
            var cmd = new NpgsqlCommand(pSql, ConexionPG);
            this.IsError = false;
        ...
        {
            var vDatos = new NpgsqlDataAdapter(sql, ConexionPG);
        ...
        public NpgsqlConnection ConexionPG { set; get; }
        ...
        public void IniciarTransaccion()
        {
            ...
            {
                this.Transaccion = this.ConexionPG.BeginTransaction();
